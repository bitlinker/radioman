...
public class IcyInputStream extends FilterInputStream {
     ...
     * @param in               the underlying input stream
     * @param period           the period of metadata frame is repeating (in bytes)
     * @param metadataCallback the callback - may be null
     */
    public IcyInputStream(InputStream in, int period, MetadataCallback metadataCallback) {
        this(in, period, metadataCallback, null);
    }
     ...
     */
    public IcyInputStream(InputStream in, int period, MetadataCallback metadataCallback, String characterEncoding) {
        super(in);
        this.period = period;
    ...
    protected void parseMetadata(String s) {
        ...
        for (String kv : kvs) {
            ...
            if (metadataCallback != null) metadataCallback.onMetadataUpdate(key, val);
        }
    }
